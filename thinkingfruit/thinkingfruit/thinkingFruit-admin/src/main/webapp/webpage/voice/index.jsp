...
<body>
			...
			<div class="layui-form xbs">
				<div class="layui-form-pane">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline xbs768">
							<input type="text" name="name" value="" placeholder="请输入歌手名"
								autocomplete="off" class="layui-input">
						</div>
						
						<div class="layui-input-inline xbs768">
							<input type="text" name="songName" value="" placeholder="请输入歌名"
								autocomplete="off" class="layui-input">
						</div>
   ...
   {{#
	...
	<script type="text/javascript" src="<%=basePath%>/static/js/voice/index.js"></script>
</body>
</html>