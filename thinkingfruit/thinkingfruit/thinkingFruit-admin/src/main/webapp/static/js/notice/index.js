...
var notice_index_ops={
		...
		eventBind:function(){
			...
			$(".btn-add").click(function(){
				window.location.href = WEB_ROOT + '/notice/set';
			});
		},
				...
				table = layui.table;
				   ...
				   var tableIns = table.render({
				       ...
				       , cols: [[                          //标题栏
				           ...
				           , {field: 'title', title: '公告标题', width: 250,align: 'center'}
				           , {field: 'author', title: '公告作者', align: 'center',width: 150}
				       ...
				       , id: 'dataCheck'
				       , url: WEB_ROOT + "/notice/pagination"
				       , method: 'get'
				       , page: true
				       , limit: 10 //默认采用30
				       , limits :[10]
					...
					table.on('tool(table-data)', function(obj) {
						...
						if(obj.event == 'detail'){
							//修改新闻信息
							window.location.href = WEB_ROOT + '/notice/set?id='+id;
						}else{
							//ajax删除
							var msg = "确认删除";
							var callback = {
