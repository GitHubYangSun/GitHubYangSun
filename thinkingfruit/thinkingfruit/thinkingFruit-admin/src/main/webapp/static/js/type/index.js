...
var type_index_ops={
		...
		eventBind:function(){
			...
			$(".btn-add").click(function(){
				window.location.href = WEB_ROOT + '/type/set';
			});
		},
				...
				table = layui.table;
				   ...
				   var tableIns = table.render({
				       ...
				       , cols: [[                          //标题栏
				           ...
				           , {field: 'parentId', title: '父类Id', align: 'center',width: 110}
					...
					table.on('tool(table-data)', function(obj) {
						...
						if(obj.event == 'detail'){
							//修改信息
							window.location.href = WEB_ROOT + '/type/set?id='+id;
						}else{
							//ajax删除
							var msg = "确认删除";
							var callback = {
