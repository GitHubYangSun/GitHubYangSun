...
var voice_index_ops={
		...
		eventBind:function(){
			...
			$(".btn-add").click(function(){
				window.location.href = WEB_ROOT + '/voice/set';
			});
		},
				...
				table = layui.table;
				   ...
				   var tableIns = table.render({
				       ...
				       , cols: [[                          //标题栏
				           ...
				           , {field: 'songName', title: '歌名', align: 'center',width: 120}
				           , {field: 'mobile', title: '手机号码', width: 150,align: 'center'}
				           , {field: 'name', title: '歌手', align: 'center',width: 150}
				           , {field: 'songInfo', title: '歌曲介绍',align: 'center'}
				           , {field: 'intro', title: '歌手简介',align: 'center'}
				           , {title: '操作', width: 250,height: 40, align: 'center', templet: '#barOption'} //这里的toolbar值是模板元素的选择器
				       ]]
				       , id: 'dataCheck'
				       , url: WEB_ROOT + "/voice/pagination"
				       , method: 'get'
				       , page: true
				       , limit: 10 //默认采用30
				       , limits :[10]
					...
					table.on('tool(table-data)', function(obj) {
						...
						if(obj.event == 'detail'){
							//修改新闻信息
							window.location.href = WEB_ROOT + '/voice/set?id='+id;
						}else{
							//ajax删除
							var msg = "确认删除";
							var callback = {
